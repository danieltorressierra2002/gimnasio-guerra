  ...
  return (
    <div className="min-h-screen bg-carbon texture-floor">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-10">
        ...
        {/* Hero con logo difuminado de fondo */}
        <div className="relative text-center py-16 overflow-hidden rounded-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-bone-dim mt-4 text-sm max-w-md mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {productosFiltrados.map(p => (
                <div key={p.id} className="bg-carbon-surface border border-steel/40 rounded-xl overflow-hidden">
                  {p.fotoURL && <img src={p.fotoURL} alt={p.nombre} className="w-full h-40 object-cover" />}
                  <div className="p-4 flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {p.oferta && <span className="inline-block mt-2 text-xs font-bold px-2 py-0.5 rounded-full bg-blood/15 border border-blood/40 text-blood-glow">🔥 {p.descripcionOferta || "¡OFERTA!"}</span>}
                    </div>
                  </div>
                </div>
              ))}
