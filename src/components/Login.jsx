    ...
    <div className="min-h-screen bg-carbon texture-floor flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-bone-dim text-sm mt-2 tracking-wide">Acceso al panel de membresías</p>
        </div>
        <form onSubmit={handleSubmit} className="bg-carbon-surface border border-steel/40 rounded-xl p-6 shadow-plate space-y-4">
          ...
          <button type="submit" disabled={cargando}
            className="w-full bg-forge hover:bg-forge-glow disabled:opacity-50 text-carbon font-display font-semibold uppercase tracking-wide py-3 rounded-lg transition-all active:scale-[0.98] shadow-glow-gold">
